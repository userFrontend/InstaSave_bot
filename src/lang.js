const language = {
    uz:{
        ...
        result: "Xabarni ko'rinsh",
        send: "Xabarni Jo'natish",
        successResult: "Xabar barcha foydalanuvchilarga yuborildi. Foydalanuvchilar soni -",
    ...
    ru:{
        ...
        result: 'Посмотреть сообщение',
        send: 'Отправить сообщение',
        successResult: 'Сообщение отправлено всем пользователям. Количество пользователей —',
    ...
    en:{
        ...
        result: 'View message',
        send: 'Send message',
        successResult: 'The message has been sent to all users. Number of users -',
